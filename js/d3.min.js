...
!(function (t, n) {
  ...
  function m(t, n, e) {
    ...
    if (((r = n < t) && ((i = t), (t = n), (n = i)), 0 === (a = x(t, n, e)) || !isFinite(a)))
      return [];
    if (a > 0)
      for (
  ...
  function at(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u)
      (c = n[u]) &&
        ((d[u] = f = it + a.call(c, c.__data__, u, n)), f in s ? (i[u] = c) : (s[f] = c));
    for (u = 0; u < h; ++u)
  ...
  function yn(t) {
    return (
      t instanceof Jt || (t = pn(t)), t ? new bn((t = t.rgb()).r, t.g, t.b, t.opacity) : new bn()
    );
  }
  function _n(t, n, e, r) {
  ...
  Qt(
    ...
    Kt(Jt, {
      ...
      darker: function (t) {
        return (
          (t = null == t ? 0.7 : Math.pow(0.7, t)), new re(this.h, this.s, this.l * t, this.opacity)
        );
      },
      rgb: function () {
  ...
  Ur.prototype = Or.prototype = {
    ...
    selectAll: function (t) {
      ...
      for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u)
        for (var c, f = r[u], s = f.length, l = 0; l < s; ++l)
          if ((c = f[l])) {
            for (
              var h, d = t.call(c, c.__data__, l, f), p = Cr(c, e), v = 0, g = d.length;
              v < g;
              ++v
            )
    ...
    transition: function () {
      for (
        var t = this._name, n = this._id, e = Br(), r = this._groups, i = r.length, o = 0;
        o < i;
        ++o
      )
      ...
      return new Promise(function (o, a) {
        ...
        e.each(function () {
          var e = Er(this, r),
            i = e.on;
          i !== t &&
            ((n = (t = i).copy())._.cancel.push(u), n._.interrupt.push(u), n._.end.push(c)),
            (e.on = n);
        });
      });
    }
  ...
  var ci = (function t(n) {
    ...
    si = (function t(n) {
      function e(t) {
        return (
          ((t *= 2) < 1 ? t * t * ((n + 1) * t - n) : (t -= 2) * t * ((n + 1) * t + n) + 2) / 2
        );
      }
      return (n = +n), (e.overshoot = t), e;
    })(1.70158),
  ...
  function Yi(n) {
    ...
    return (
      ...
      (h.prototype = {
        ...
        start: function () {
          return (
            this.starting ? ((this.starting = !1), this.emit('start')) : this.emit('brush'), this
          );
        },
        brush: function () {
  ...
  to.prototype = no.prototype = {
    ...
    bezierCurveTo: function (t, n, e, r, i, o) {
      this._ +=
        'C' + +t + ',' + +n + ',' + +e + ',' + +r + ',' + (this._x1 = +i) + ',' + (this._y1 = +o);
    },
  ...
  function To() {
    ...
    function o(e, i) {
      ...
      return (
        (function (e, r, i) {
          ...
          for (; ++u < n - 1; ) {
            for (
              o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, No[(f << 1) | (s << 2)].forEach(p);
              ++o < t - 1;
          ...
          r(t, e, i),
            (function (t) {
              for (
                var n = 0, e = t.length, r = t[e - 1][1] * t[0][0] - t[e - 1][0] * t[0][1];
                ++n < e;
    ...
    return (
      ...
      (i.thresholds = function (t) {
        return arguments.length
          ? ((e = 'function' == typeof t ? t : Array.isArray(t) ? bo(yo.call(t)) : bo(t)), i)
          : e;
      }),
      (i.smooth = function (t) {
  ...
  (Ta.copy = function () {
    ...
    (Ta.cover = function (t, n) {
      ...
      if (isNaN(e)) (i = (e = Math.floor(t)) + 1), (o = (r = Math.floor(n)) + 1);
        ...
        for (var a, u, c = i - e, f = this._root; e > t || t >= i || r > n || n >= o; )
          switch (
            ((u = ((n < r) << 1) | (t < e)), ((a = new Array(4))[u] = f), (f = a), (c *= 2), u)
          ) {
            case 0:
              (i = e + c), (o = r + c);
              break;
    ...
    (Ta.find = function (t, n, e) {
      ...
      for (
        ...
        if (
          !(!(v = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)
        )
          if (v.length) {
            var g = (i + a) / 2,
              y = (o + u) / 2;
    ...
    (Ta.visitAfter = function (t) {
      var n,
        ...
        r = [];
      for (
        this._root && e.push(new ba(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
  ...
  (_l.invert = function (t, n) {
    ...
    (ml.invert = function (t, n) {
      ...
      return [
        t /
          (0.8707 +
            (o = r * r) * (o * (o * o * o * (0.003971 - 0.001529 * o) - 0.013791) - 0.131979)),
        r
      ];
    }),
    (xl.invert = il(wu)),
  ...
  function Gh(n, e, r, i) {
    ...
    switch ((i = Oa(null == i ? ',f' : i)).type) {
      case 's':
        ...
        return (
          null != i.precision || isNaN((o = Wa(a, u))) || (i.precision = o), t.formatPrefix(i, u)
        );
      case '':
      case 'e':
      case 'g':
    ...
    function N(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, c = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (((i = n.charAt(a++)), !(o = x[i in xp ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0))
            return -1;
        ...
        if (
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C && ((n.C = !1), (i.C = !0), pb(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                ...
                ((n = i.L).C && ((n.C = !1), (i.C = !0), vb(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
      ...
      return (
        this.cells.forEach(function (e, r) {
          if ((o = (i = e.halfedges).length))
            for (
              var i, o, a, u = e.site, c = -1, f = n[i[o - 1]], s = f.left === u ? f.right : f.left;
              ++c < o;
  ...
  (Qb.prototype = Wb.prototype),
        ...
        for (f = -1; ++f < l; )
          for (s = f - 1; ++s < l; ) {
            var N = _[s * l + f],
              T = _[f * l + s];
            (N.value || T.value) &&
              v.push(N.value < T.value ? { source: T, target: N } : { source: N, target: T });
          }
        return r ? v.sort(r) : v;
      }
      return (
      ...
      function m(n, e, r, i, o) {
        ...
        if (
          ...
          return function t(u) {
            ...
            kt(new Vt(d, u, a, n, s, p[0] + c, p[1] + h, p[0] - g[0], p[1] - g[1], v), v.apply, v, [
              u,
              i,
              o
            ]);
    ...
    (t.geoPath = function (t, n) {
      ...
      function o(t) {
        return (
          t && ('function' == typeof i && r.pointRadius(+i.apply(this, arguments)), Cu(t, e(r))),
          r.result()
        );
      }
      return (
        ...
        'rgb(' +
          Math.max(
            ...
            Math.min(
              255,
              Math.round(
                -4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - 2710.57 * t))))
              )
            )
          ) +
          ', ' +
          Math.max(
            ...
            Math.min(
              255,
              Math.round(
                32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - 67.37 * t))))
              )
            )
          ) +
          ', ' +
        ...
        'rgb(' +
          Math.max(
            ...
            Math.min(
              ...
              Math.round(
                34.61 +
                  t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - 14825.05 * t))))
              )
            )
          ) +
          ', ' +
    ...
    (t.ribbon = function () {
      ...
      function a() {
        ...
        if (
          ...
          o.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (o.quadraticCurveTo(0, 0, v * Ii(g), v * Hi(g)), o.arc(0, 0, v, g, y)),
    ...
    (t.stack = function () {
      ...
      return (
        ...
        (i.order = function (t) {
          return arguments.length
            ? ((n = null == t ? rb : 'function' == typeof t ? t : my(t_.call(t))), i)
            : n;
        }),
        (i.offset = function (t) {
      ...
      if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
        for (var e, r, i, o = 0, a = 1; a < r; ++a) {
          for (var u = 0, c = 0, f = 0; u < i; ++u) {
            for (
              var s = t[n[u]], l = s[a][1] || 0, h = (l - (s[a - 1][1] || 0)) / 2, d = 0;
              d < u;
              ++d
            ) {
              var p = t[n[d]];
            ...
            i = Rt(t.event.view)
              .on(
                ...
                function () {
                  ...
                  n.zoom(
                    'mouse',
                    o(_(n.that.__zoom, (n.mouse[0] = Bt(n.that)), n.mouse[1]), n.extent, f)
                  );
                },
                !0
              )
